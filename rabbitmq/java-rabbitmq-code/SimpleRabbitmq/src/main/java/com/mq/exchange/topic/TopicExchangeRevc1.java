...
public class TopicExchangeRevc1 {
	public static void main(String[] args) throws Exception {
		...
		// 声明队列
		channel.queueDeclare(PublicParam.TOPIC_QUEUE_NAME1, false, false,
				false, null);
		// 声明consumer
		...
		// 进行消息监听
		channel.basicConsume(PublicParam.TOPIC_QUEUE_NAME1, consumer);
	}
}
