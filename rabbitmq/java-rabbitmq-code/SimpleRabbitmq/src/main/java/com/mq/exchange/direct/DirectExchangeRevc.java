...
public class DirectExchangeRevc {
	public static void main(String[] args) throws Exception {
		...
		// 声明队列
		channel.queueDeclare(PublicParam.DIRECT_EXCHANGE_NAME, false, false,false, null);
		// 声明consumer
		...
		// 进行消息监听
		channel.basicConsume(PublicParam.DIRECT_EXCHANGE_NAME, consumer);
	}
}
